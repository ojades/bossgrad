...
class QuestHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final initial = childName.isNotEmpty ? childName[0].toUpperCase() : 'P';

    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        // 1. Player Profile Dropdown Pill (Left)
        Theme(
          ...
          child: PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              const PopupMenuItem(
                ...
                child: Row(
                  children: [
                    Icon(LucideIcons.user, size: 18, color: Color(0xFF756B91)),
                    SizedBox(width: 10),
                    Text(
                      'My Profile',
                      style: TextStyle(
        ...
        // 2. Stats - Live XP, Coins, and Star Rank (Right)
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            _HeroStatPill(
